    ...
    <div class="min-h-screen bg-gray-50 flex flex-col justify-center items-center px-4">
      <div class="w-full max-w-md bg-white rounded-lg shadow-sm p-8">
        ...
        <div class="text-center mb-8">
          <h1 class="text-3xl font-bold text-gray-900">Signup to Sensi'il</h1>
        </div>
        ...
        <form class="space-y-6" @submit.prevent="handleLogin">
          ...
          <div>
            <div class="flex justify-between items-center mb-1">
              ...
              <NuxtLink to="/forgot pa" class="text-sm text-primary hover:text-primary-dark">
    Forgot Password?
  </NuxtLink>
            </div>
            <div class="relative">
        ...
        <div class="mt-8 text-center text-sm text-gray-500">
          ...
          <NuxtLink to="/Login" class="font-medium text-primary hover:text-primary-dark">Login here</NuxtLink>
        </div>
      </div>
    </div>
  </template>
